...
public enum TutorialConditionType
{
    ...
    WaitForClick,           // Wait for mouse click
    WaitForSeconds,         // Wait for time delay
...
public class TutorialStep : ScriptableObject
{
    ...
    [Tooltip("For RockReleased/RockStopped/RockPullbackThreshold: which rock index to watch (-1 for current rock)")]
