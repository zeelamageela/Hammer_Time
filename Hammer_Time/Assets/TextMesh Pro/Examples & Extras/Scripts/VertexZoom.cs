        ...
        IEnumerator AnimateVertexColors()
        {
            ...
            while (true)
            {
                ...
                for (int i = 0; i < textInfo.meshInfo.Length; i++)
                {
                    ...
                    // Convert Vector4[] to Vector2[] for mesh.uv assignment
                    Vector4[] uvs0 = textInfo.meshInfo[i].uvs0;
                    Vector2[] uvs0_2 = new Vector2[uvs0.Length];
                    for (int j = 0; j < uvs0.Length; j++)
                    {
                        uvs0_2[j] = new Vector2(uvs0[j].x, uvs0[j].y);
                    }
                    textInfo.meshInfo[i].mesh.uv = uvs0_2;
